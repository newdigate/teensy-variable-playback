...
BOOST_AUTO_TEST_SUITE(test_audio_wav_stereo_pingpong_forward_playback)
    ...
    BOOST_FIXTURE_TEST_CASE(Wav_fwd_1_0000_quadratic_stereo_pingpong, AudioWavFixture) {
        ...
        const std::string testName = "Wav_fwd_1_0000_quadratic_stereo_pingpong";
        ...
        wave.begin();
        wave.setLoopStart(0); 
        wave.setLoopFinish(1000);
        wave.setLoopType(loop_type::looptype_pingpong);
        wave.enableInterpolation(true);
        wave.setPlaybackRate(playbackRate);
        wave.playWav("stereo.wav");
    ...
    BOOST_FIXTURE_TEST_CASE(Wav_fwd_0_5000_quadratic_stereo_pingpong, AudioWavFixture) {
        ...
        const std::string testName = "Wav_fwd_0_5000_quadratic_stereo_pingpong";
        const std::string outputFile = testName+".wav";
        const std::string outputFileName = outputPath + outputFile;
        const std::string referenceFileName = referencePath + testName + ".wav";
        SD.setSDCardFolderPath(inputPath);
    ...
    BOOST_FIXTURE_TEST_CASE(Wav_fwd_2_0000_quadratic_stereo_pingpong, AudioWavFixture) {
        ...
        const std::string testName = "Wav_fwd_2_0000_quadratic_stereo_pingpong";
        const std::string outputFile = testName+".wav";
        const std::string outputFileName = outputPath + outputFile;
        const std::string referenceFileName = referencePath + testName + ".wav";
        SD.setSDCardFolderPath(inputPath);
    ...
    BOOST_FIXTURE_TEST_CASE(Wav_fwd_0_7437_quadratic_stereo_pingpong, AudioWavFixture) {
        ...
        const std::string testName = "Wav_fwd_0_7437_quadratic_stereo_pingpong";
        const std::string outputFile = testName+".wav";
        const std::string outputFileName = outputPath + outputFile;
        const std::string referenceFileName = referencePath + testName + ".wav";
        SD.setSDCardFolderPath(inputPath);
    ...
    BOOST_FIXTURE_TEST_CASE(Wav_fwd_1_7437_quadratic_stereo_pingpong, AudioWavFixture) {
        ...
        const std::string testName = "Wav_fwd_1_7437_quadratic_stereo_pingpong";
        const std::string outputFile = testName+".wav";
        const std::string outputFileName = outputPath + outputFile;
        const std::string referenceFileName = referencePath + testName + ".wav";
        SD.setSDCardFolderPath(inputPath);
    ...
    BOOST_FIXTURE_TEST_CASE(Wav_fwd_8_7437_quadratic_stereo_pingpong, AudioWavFixture) {
        ...
        const std::string testName = "Wav_fwd_8_7437_quadratic_stereo_pingpong";
        const std::string outputFile = testName+".wav";
        const std::string outputFileName = outputPath + outputFile;
        const std::string referenceFileName = referencePath + testName + ".wav";
        SD.setSDCardFolderPath(inputPath);
